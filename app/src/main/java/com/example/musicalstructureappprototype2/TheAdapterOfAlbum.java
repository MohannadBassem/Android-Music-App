...
public class TheAdapterOfAlbum extends RecyclerView.Adapter<TheAdapterOfAlbum.TheHolder2> {
    private Context bContext;
    private ArrayList<Files> The_Files_Of_Album;
    View view;
    public TheAdapterOfAlbum(Context bContext, ArrayList<Files> The_Files_Of_Album) {
    ...
    public TheHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(bContext).inflate(R.layout.itemsofalbum,parent,false);
        return new TheHolder2(view);
    }
    @Override
    public void onBindViewHolder(@NonNull TheHolder2 holder, final int position) {
        holder.TheName_OfAlbum.setText(The_Files_Of_Album.get(position).getAlbum());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(bContext, albummusiclist.class);
                intent.putExtra("albumName", The_Files_Of_Album.get(position).getAlbum());
    ...
    public class TheHolder2 extends RecyclerView.ViewHolder {
        ...
        public TheHolder2(@NonNull View itemView) {
            super(itemView);
            TheImg_OfAlbum = itemView.findViewById(R.id.TheImg_OfAlbum);
            TheName_OfAlbum = itemView.findViewById(R.id.TheName_OfAlbum);
        }
    }
